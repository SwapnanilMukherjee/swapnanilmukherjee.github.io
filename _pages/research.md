...
<div class="section">
  ...
  <ul class="research-list">
    ...
    <li><p><b>Modality Bias and Preference in MLLMs:</b> In collaboration with Precog and Tanuja Ganu (Microsoft Research India), we developed <b>C³PO</b>, a benchmark for evaluating multimodal reasoning across vision, audio, video, and text. Through paired information composition and counterfactual conflict tasks, C³PO diagnoses when and why multimodal LLMs fail. Our analyses reveal that current models exhibit strong modality dominance, often overlooking contradictory evidence from other modalities, highlighting the need for architectures that support sustained cross-modal reasoning. Paper currently under review.</p></li>
