        ...
        <div>
          ...
          <div className="flex items-center gap-1">
            ...
            <a href="https://bsky.app/profile/yourusername.bsky.social" target="_blank" rel="noopener noreferrer"
               className="p-2 text-muted-foreground hover:text-accent transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.139 1.908 0 3.08 0 3.768c0 .69.378 5.65.624 6.479.815 2.736 3.713 3.66 6.383 3.364.136-.02.275-.039.415-.056-.138.018-.276.037-.415.056-2.67-.296-5.568.628-6.383 3.364C.378 17.58 0 22.541 0 23.231c0 .688.139 1.86.902 2.203.659.299 1.664.621 4.3-1.24C7.954 22.053 10.913 18.114 12 16.2c1.087 1.914 4.046 5.853 6.798 7.795 2.636 1.861 3.641 1.539 4.3 1.24.763-.343.902-1.515.902-2.203 0-.69-.378-5.651-.624-6.479-.815-2.736-3.713-3.66-6.383-3.364-.139.017-.277.036-.415.056.138-.017.276-.036.415-.056 2.67.296 5.568-.628 6.383-3.364.246-.828.624-5.789.624-6.479 0-.688-.139-1.86-.902-2.203-.659-.299-1.664-.621-4.3 1.24C16.046 4.747 13.087 8.686 12 10.8z"/>
              </svg>
            </a>
            <a href="mailto:your.email@university.edu" className="p-2 text-muted-foreground hover:text-accent transition-colors">
